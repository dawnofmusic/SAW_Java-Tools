 ...
 * @version $Author: sweiss $ -- $Revision: 1.8 $ -- $Date: 2005/11/17 19:09:45
 *          $ <br>
...
public final class GUIToolkit {
	...
	final JSlider slid = new JSlider(SwingConstants.HORIZONTAL,
		(int) Math.round(minVal * mult),
		(int) Math.round(maxVal * mult), (int) Math.round(ph.getVal()
			* mult));
	...
	item.add(
		...
		new GBC()
			.pos(0, 0)
			.anchorNorthWest()
			.insets(DEFAULT_INSET, DEFAULT_INSET, DEFAULT_INSET,
				DEFAULT_INSET));
	...
	item.add(
		slid,
		new GBC().pos(0, 1).anchorNorthWest()
			.insets(0, DEFAULT_INSET, DEFAULT_INSET, DEFAULT_INSET)
			.fillBoth(1.0, 0));
	return item;
    }
	...
	JSpinner spinner = new JSpinner(new SpinnerNumberModel(
		...
		Integer.valueOf(MAX_ZIP_CODE), Integer.valueOf(1)));
...
/*
 * $Log: GUIToolkit.java,v $ Revision 1.8 2009-02-09 16:54:25 sweiss bug fixing
 * and cleanup
 * 
 * Revision 1.7 2008-03-28 14:17:26 sweiss smaller change
 * 
 * Revision 1.6 2007-08-03 14:06:32 sweiss renaming method
 * 
 * Revision 1.5 2007-05-30 17:46:09 sweiss *** empty log message ***
 * 
 * Revision 1.4 2006/07/15 15:57:59 sweissTFH *** empty log message ***
 * 
 * Revision 1.3 2006/06/10 17:57:30 sweissTFH clean up
 * 
 ...
 * Revision 1.10 2005/12/27 16:06:01 sweissTFH moved to java 5 and very big
 * clean up!
 * 
